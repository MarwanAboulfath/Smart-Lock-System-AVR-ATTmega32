...
static void (*Global_pvInt0NotifcationFunction)(void) = NULL_ptr;
static void (*Global_pvInt1NotifcationFunction)(void) = NULL_ptr;
static void (*Global_pvInt2NotifcationFunction)(void) = NULL_ptr;
...
{
	if (Copy_pvNotificationFunction != NULL_ptr)
	{
...
void __vector_1 (void)
{
	...
	if (Global_pvInt0NotifcationFunction != NULL_ptr)
	{
...
void __vector_2 (void)
{
	...
	if (Global_pvInt1NotifcationFunction != NULL_ptr)
	{
...
void __vector_3 (void)
{
	...
	if (Global_pvInt2NotifcationFunction != NULL_ptr)
	{
